#ifndef _ALTERA_FFT_SUB_SGDMA_FROM_FFT_H_
#define _ALTERA_FFT_SUB_SGDMA_FROM_FFT_H_
...
/*
 * This file contains macros for module 'fft_sub_sgdma_from_fft' and devices
...
#endif /* _ALTERA_FFT_SUB_SGDMA_FROM_FFT_H_ */
